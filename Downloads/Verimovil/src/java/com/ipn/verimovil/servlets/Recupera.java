...
public class Recupera extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger.getLogger("com.ipn.verimovil.servlets.Recupera");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Response r = rc.enviarMail(user);
        switch (r.getStatus()) {

            case STATUS_OK:
                LOGGER.log(Level.INFO, "Se envio peticion de correo de {0}", user);
